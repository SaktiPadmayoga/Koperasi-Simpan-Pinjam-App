...
public class CompleteSavingView extends javax.swing.JFrame {
    ...
    public CompleteSavingView(Accounts account, Transactions transaction, Savings saving, String nama) {
        ...
        tanggalSimpan.setText(LocalDate.now().toString());
    ...
    private void initComponents() {
        ...
        backBtn = new com.swing.PanelBorder1();
        ...
        backBtn.setMaximumSize(new java.awt.Dimension(308, 53));
        backBtn.setMinimumSize(new java.awt.Dimension(308, 53));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CompleteSavingView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CompleteSavingView(new Accounts(0, 0, new Members(0, "", "", "", "", ""), "", ""), new Transactions("",0,"",""), new Savings("", "", "", "", 0.0, 0), "").setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private com.swing.PanelBorder1 backBtn;
