...
public class ConfirmSavingView extends javax.swing.JFrame {
    
    private Accounts account;
    private double nominal;
    private String nama, saving_type, payment_method;
    ...
    public ConfirmSavingView(Accounts account, String nama, double nominal, String saving_type, String payment_method) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Konfirmasi Penyimpanan");
       ...
       String getPassword = String.valueOf(password.getPassword());
        if(count != 3){
            if(getPassword.equals(account.getPassword())){
                ...
                int saving_id = ThreadLocalRandom.current().nextInt(10000000);
                Transactions transaction = new Transactions("TR-"+transaction_id, account.getAccount_id(), "SV-"+saving_id, LocalDateTime.now().toString());
                TransactionsControl.insertTransaction(transaction);
                Savings saving = new Savings("SV-"+saving_id, saving_type, LocalDateTime.now().toString(), payment_method, nominal, account.getAccount_id());
                savingControl.insertSavings(saving);
                account.setBalance(account.getBalance() + nominal);
                this.dispose();
                new CompleteSavingView(account, transaction, saving, nama).setVisible(true);
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmSavingView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConfirmSavingView(new Accounts(0, 0, new Members(0, "", "", "", "", ""), "", ""),"", 0.0,"", "").setVisible(true);
            }
        });
    }
