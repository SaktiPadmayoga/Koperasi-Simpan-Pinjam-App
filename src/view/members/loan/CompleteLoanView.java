...
public class CompleteLoanView extends javax.swing.JFrame {
    ...
    public CompleteLoanView(Accounts account, Transactions transaction, Loans loan) {
        initComponents();
        initJFrame();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CompleteLoanView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CompleteLoanView(new Accounts(0, 0.0, new Members(0, "", "", "", "", ""), "", ""), new Transactions("",0,"",""), new Loans("", "", "", "", 0.0, 0, "", 0, "")).setVisible(true);
            }
        });
    }
