...
public class EmployeesDAO {
    ...
    public void insertEmployee(Employees em){
        ...
        String sql = "INSERT INTO employees(employee_id, first_name, last_name, username, password, start_work_date,"
                + " end_work_date, role_id, station_number, office_number) VALUES ('" 
                + em.getEmployee_id() + "','" + em.getFirst_name() + "', '"
                + em.getLast_name() + "', '" + em.getUsername() + "', '" 
                + em.getPassword() + "', '" + em.getStart_work_date() + "', '"
                + em.getEnd_work_date() + "', '" + em.getRole_id() + "', '"
