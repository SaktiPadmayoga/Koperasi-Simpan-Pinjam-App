    ...
    public Loans getLoan(String loan_id, String status){
        if(!status.equals("")){
            try {
                ...
                if(rs.next()){
                    Loans loan = new Loans(rs.getString("loan_id"), rs.getString("loan_type"), 
                            rs.getString("loan_start_date"), rs.getString("loan_end_date"), 
                            rs.getDouble("amount"), rs.getFloat("interest_rate"), 
                            rs.getString("interest_rate_type"), rs.getDouble("end_amount_pay"), 
