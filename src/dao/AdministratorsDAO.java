...
public class AdministratorsDAO {
    ...
    public void updateAdministrator(Administrators a){
        ...
        String sql = "UPDATE administrators SET username = '"+ a.getUsername() + "', password = '" 
                + a.getPassword() + "'" + " WHERE administrator_id = '" + a.getAdministrator_id() + "'";
    ...
    public Administrators searchAdmin(Administrators admin){
        ...
        String sql = "SELECT * from administrators WHERE username = '" + admin.getUsername() + "' "
